...
namespace King {
	...
	void Engine::Render(Engine::Texture texture, const glm::mat4& transform, float alpha) {
	...
	void Engine::Render(Texture texture, float x, float y, float rotation, float alpha) {
		...
		Render(texture, transformation, alpha);
	}
